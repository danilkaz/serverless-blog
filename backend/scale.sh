...
yc serverless container revision deploy \
  ...
  --environment SERVERLESS_BLOG_YDB_ENDPOINT=${SERVERLESS_BLOG_YDB_ENDPOINT},SERVERLESS_BLOG_YDB_API_TOKEN=${YC_TOKEN},SERVERLESS_BLOG_BACKEND_VERSION=${SERVERLESS_BLOG_BACKEND_VERSION} \
